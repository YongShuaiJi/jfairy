 ...
 * <ul>
 * <li>Specifies the locale for the random data file.</li>
 * <li> Specifies the file prefix.
 * (So if you specify "jfairy" here and English for Locale, the data file will be
 * "jfairy_en.yml" under the classpath.)
 * </li>
 * <li>The Random object to use.</li>
 * <li> A specific random seed to use. Use this if you want the resulting
 ...
 * </li>
 * </ul>
 * Obviously, don't set both and only the last one you set will
